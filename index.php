...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="<?php echo get_theme_file_uri('css/skins/green.css');?>">

        <!--[if lt IE 9]>
            <script src="//html5shiv.googlecode.com/svn/trunk/html5.js"></script>
            <script>window.html5 || document.write('<script src="<?php echo get_theme_file_uri('js/vendor/html5shiv.js');?>"><\/script>')</script>
        <![endif]-->
    </head>
    <body class="body-box">
        <!-- preloader -->
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 profile-image wow bounceInUp center animated">
                            <img  class="img-responsive" src="<?php echo get_theme_file_uri('images/profile.png');?>" alt="" />
                        </div><!-- end of /.column-->
                        <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 profile-item wow flipInX center animated">
                            <article class="profile-caption">
                                <h2>Hello, I'm <span>Robal hakson</span></h2>
                            ...
                            <div class="portfolio-item gallery">
                                <div class="single-portfolio web mobile col-md-4 col-sm-6 col-xs-12" data-category="transition">
                                    <div class="portfolio-single-item">
                                        <a href="<?php echo get_theme_file_uri('images/work-1.jpg');?>" data-gal="prettyPhoto[gallery1]">
                                            <img src="<?php echo get_theme_file_uri('images/work-1.jpg');?>" width="360" height="307" alt="portfolio image 1">
                                        </a>
                                    </div>
                                </div>
                                <div class="single-portfolio mobile landing col-md-4 col-sm-6 col-xs-12" data-category="metalloid">
                                    <div class="portfolio-single-item">
                                        <a href="<?php echo get_theme_file_uri('images/work-2.jpg');?>" data-gal="prettyPhoto[gallery1]">
                                            <img src="<?php echo get_theme_file_uri('images/work-2.jpg');?>" width="360" height="307" alt="Portfolio image 2">
                                        </a>
                                    </div>
                                </div>
                                <div class="single-portfolio mobile col-md-4 col-sm-6 col-xs-12" data-category="transition">
                                    <div class="portfolio-single-item">
                                        <a href="<?php echo get_theme_file_uri('images/work-3.jpg');?>" data-gal="prettyPhoto[gallery1]">
                                            <img src="<?php echo get_theme_file_uri('images/work-3.jpg');?>" width="360" height="307" alt="Portfolio Image 3">
                                        </a>
                                    </div>
                                </div>
                                <div class="single-portfolio web ecommarce landing col-md-4 col-sm-6 col-xs-12" data-category="transition">
                                    <div class="portfolio-single-item">
                                        <a href="<?php echo get_theme_file_uri('images/work-4.jpg');?>" data-gal="prettyPhoto[gallery1]">
                                            <img src="<?php echo get_theme_file_uri('images/work-4.jpg');?>" width="360" height="307" alt="Portfolio Image 4">
                                        </a>
                                    </div>
                                </div>
                                <div class="single-portfolio landing ecommarce col-md-4 col-sm-6 col-xs-12" data-category="transition">
                                    <div class="portfolio-single-item">
                                        <a href="<?php echo get_theme_file_uri('images/work-5.jpg');?>" data-gal="prettyPhoto[gallery1]">
                                            <img src="<?php echo get_theme_file_uri('images/work-5.jpg');?>" width="360" height="307" alt=" Portfolio Image 5">
                                        </a>
                                    </div>
                                ...
                                <div class="single-portfolio web ecommarce col-md-4 col-sm-6 col-xs-12" data-category="transition">
                                    <div class="portfolio-single-item">
                                        <a href="<?php echo get_theme_file_uri('images/work-6.jpg');?>" data-gal="prettyPhoto[gallery1]">
                                            <img src="<?php echo get_theme_file_uri('images/work-6.jpg');?>" width="360" height="307" alt="Portfolio Image 6">
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="client-carousel" class="owl-carousel owl-theme">
                            <div class="item">
                                <div class="client-box">
                                    <img src="<?php echo get_theme_file_uri('images/client-1.jpg');?>" width="125" height="140" alt=""><!-- client profile -->
                            ...
                            <div class="item">
                                <div class="client-box">
                                    <img src="<?php echo get_theme_file_uri('images/client-2.jpg');?>" width="125" height="140" alt=""><!-- clien profile image -->
                                    <p>"Marcus is a full time Internet Marketing Analyst and Strategist. Her brain is an ocean of ideas and creativeness, and she loves expressing and sharing those ideas on her writings and artworks. Good service provider."</p>
                                    <span>
                            ...
                            <div class="item">
                                <div class="client-box">
                                    <img src="<?php echo get_theme_file_uri('images/client-1.jpg');?>" width="125" height="140" alt=""><!-- clien profile image -->
                                    <p>"Marcus is a full time Internet Marketing Analyst and Strategist. Her brain is an ocean of ideas and creativeness, and she loves expressing and sharing those ideas on her writings and artworks. Good service provider."</p>
                                    <span>
                                        <b>Porots Emmarn</b><br>
                                        c.e.o Nahina Studio ltd
        ...
        <!-- jquery library -->
        <script src="<?php echo get_theme_file_uri('js/vendor/jquery-1.11.2.min.js');?>"></script>
        <!-- Bootstarp -->
        <script src="<?php echo get_theme_file_uri('js/vendor/bootstrap.min.js');?>"></script>
        <!-- parallax -->
        <script src="<?php echo get_theme_file_uri('js/jquery.parallax-1.1.3.js');?>"></script>
        <!-- owl carosuel -->
        <script src="<?php echo get_theme_file_uri('js/owl.carousel.min.js');?>"></script>
        <!-- isotope -->
        <script src="<?php echo get_theme_file_uri('js/isotope.pkgd.min.js');?>"></script>
        <!-- placeholdem -->
        <script src="<?php echo get_theme_file_uri('js/placeholdem.min.js');?>"></script>
        <!-- prettyPhoto -->
        <script src="<?php echo get_theme_file_uri('js/jquery.prettyPhoto.js');?>"></script>
        <!-- switcher -->
        <script src="<?php echo get_theme_file_uri('js/switcher.js');?>"></script>
        <!-- wow js -->
